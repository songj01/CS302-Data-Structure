...
class BankSimulation2{
    ...
    private:
      static const int tellerNums = 3;///< Define the total number of tellers.
      ...
      int idleTime[tellerNums];///< Dcalre the idle time of teller.
      int totalIdleTime[tellerNums];///< Dcalre the total idle time of teller.
